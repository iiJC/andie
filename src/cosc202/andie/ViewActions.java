...
public class ViewActions {
    ...
    private void createActions() {
        String ZoomIn = Settings.getLanguageProperty("ZoomIn");
        String ZoomOut = Settings.getLanguageProperty("ZoomOut");
        String ZoomFull = Settings.getLanguageProperty("ZoomFull");

        actions.add(new ZoomInAction(ZoomIn, null, Settings.getLanguageProperty("ZoomIndesc"),
                Integer.valueOf(KeyEvent.VK_PLUS)));
        actions.add(new ZoomOutAction(ZoomOut, null, Settings.getLanguageProperty("ZoomOutdesc"),
                Integer.valueOf(KeyEvent.VK_MINUS)));
        actions.add(new ZoomFullAction(ZoomFull, null, Settings.getLanguageProperty("ZoomFulldesc"),
    ...
    public JMenu createMenu() {
        JMenu viewMenu = new JMenu(Settings.getLanguageProperty("View"));

        for (Action action : actions) {
            viewMenu.add(new JMenuItem(action)).setAccelerator(
